...
torchrun \
    ...
    --test_file acs/acs-331.csv,Img2Mol/CLEF.csv,Img2Mol/JPO.csv,Img2Mol/UOB.csv,Img2Mol/USPTO.csv,Img2Mol/staker.csv,uspto_test/uspto_indigo.csv,uspto_test/uspto_chemdraw.csv \
