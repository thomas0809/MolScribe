...
from molscribe.chemistry import postprocess_smiles, convert_graph_to_smiles
from molscribe.tokenizer import NodeTokenizer
...
def main():
    ...
    tokenizer = {"atomtok_coords": NodeTokenizer(64, 'molscribe/vocab_uspto_new.json', True)}
